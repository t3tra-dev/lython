...
entry:
  %t0 = icmp sle i32 %n, 1
  br i1 %t0, label %if.then.0, label %if.else.1
if.then.0:
  ret i32 %n
if.else.1:
  br label %if.end.2
...
entry:
  ...
  %t6 = call i32 @fib(i32 35)
  %t7 = call ptr @PyInt_FromI32(i32 %t6)
  %t8 = call ptr @PyObject_Str(ptr %t7)
  call void @print(ptr %t8)
  %t10 = load ptr, ptr @Py_None
  call void @Py_INCREF(ptr %t10)
  call void @Py_DECREF(ptr %t10)
  ret i32 0
}