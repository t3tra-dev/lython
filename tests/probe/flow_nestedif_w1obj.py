...
#   loc(fused<{ly.source.end_col = 11 : i32, ly.source.end_line = 30 : i32, ly.source.start_col = 6 : i32, ly.source.start_line = 30 : i32}>["/Users/user/Desktop/dev/lython/.claude/worktrees/agent-a121ace38a4d2e6ff/tests/pro
