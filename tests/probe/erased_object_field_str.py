...
#   in field 'class.v'; annotate the field with the concrete class it holds`。
...
#   a type-erased `object` value cannot be stored in field 'class.v'; annotate the field with the concrete class it holds
