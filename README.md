...
┃ runtime        ┃ time              ┃ result  ┃
┡━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━┩
│ C              │ 36.56ms (x1.00)   │ 9227465 │
│ Python(pyc)    │ 45.45ms (x1.24)   │ 9227465 │
│ Bun            │ 55.97ms (x1.53)   │ 9227465 │
│ Deno           │ 76.99ms (x2.11)   │ 9227465 │
│ Node.js        │ 99.51ms (x2.72)   │ 9227465 │
│ Python         │ 629.07ms (x17.21) │ 9227465 │
│ Python(no GIL) │ 891.87ms (x24.39) │ 9227465 │
└────────────────┴───────────────────┴─────────┘
```

pycはPythonコードをLLVM IRに変換し、実行可能バイナリにコンパイルします。
