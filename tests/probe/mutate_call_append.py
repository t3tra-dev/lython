...
#   loc(fused<{ly.source.end_col = 31 : i32, ly.source.end_line = 18 : i32, ly.source.start_col = 0 : i32, ly.source.start_line = 18 : i32}>["/Users/user/Desktop/dev/lython/.claude/worktrees/agent-a121ace38a4d2e6ff/tests/pro
